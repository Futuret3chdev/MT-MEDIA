...
/** Casino floor — free play + $MT session buy-in per table. */
export const FLOOR_MODES = {
  'blackjack-free': {
    id: 'blackjack-free',
    title: 'Blackjack',
    subtitle: 'Free play · 3:2 blackjack',
    game: 'blackjack',
    currency: 'free',
    symbol: '₵',
    badge: 'FREE',
    chipValues: [10, 25, 50, 100, 500],
    maxBet: 5000,
    minBet: 5,
    buyIn: 0,
    icon: '🃏'
  ...
  'blackjack-mt': {
    id: 'blackjack-mt',
    title: 'Blackjack',
    subtitle: '$MT table · 3:2 blackjack',
    game: 'blackjack',
    currency: 'mt',
    symbol: '$MEMETORRENT',
    badge: '$MT',
    chipValues: [0.01, 0.05, 0.1, 0.5, 1],
    maxBet: 5,
    minBet: 0.01,
    buyIn: 1,
    icon: '🃏'
  ...
  'roulette-free': {
    id: 'roulette-free',
    title: 'Roulette',
    subtitle: 'Free play · European wheel',
    game: 'roulette',
    currency: 'free',
    symbol: '₵',
    badge: 'FREE',
  ...
  'roulette-mt': {
    id: 'roulette-mt',
    title: 'Roulette',
    subtitle: '$MT table · European wheel',
    game: 'roulette',
    currency: 'mt',
    symbol: '$MEMETORRENT',
    badge: '$MT',
  ...
  'baccarat-free': {
    id: 'baccarat-free',
    title: 'Baccarat',
    subtitle: 'Free play · punto banco',
    game: 'baccarat',
    currency: 'free',
    symbol: '₵',
    badge: 'FREE',
  ...
  'baccarat-mt': {
    id: 'baccarat-mt',
    title: 'Baccarat',
    subtitle: '$MT live table · 8:1 tie',
    game: 'baccarat',
    currency: 'mt',
    symbol: '$MEMETORRENT',
    badge: '$MT',
...
export const CASINO_GAME_SECTIONS = [
  ...
  },
  {
    ...
    games: [
      { id: 'blackjack-free', modeId: 'blackjack-free', status: 'live' },
      { id: 'blackjack-mt', modeId: 'blackjack-mt', status: 'live' },
      { id: 'roulette-free', modeId: 'roulette-free', status: 'live' },
      { id: 'roulette-mt', modeId: 'roulette-mt', status: 'live' },
      { id: 'baccarat-free', modeId: 'baccarat-free', status: 'live' },
      { id: 'baccarat-mt', modeId: 'baccarat-mt', status: 'live' },
