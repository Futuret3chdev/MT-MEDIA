let scoreLeftEl = document.getElementById("score-left");
let scoreRightEl = document.getElementById("score-right");
...
// Completely disable scrolling and touch dragging
...
pauseBtn.onclick = () => {
  ...
  document.getElementById("pause-icon").textContent =
    gamePaused ? "▶️" : "⏸️"; // Play / Pause icons
};
