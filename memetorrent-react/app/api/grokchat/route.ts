...
export async function POST(request: NextRequest) {
  try {
    ...
    if (lower.includes('hello') || lower.includes('hi') || lower.includes('hey') || lower.includes('greet')) {
      ...
      reply = "Developer APIs: https://memetorrent.futuret3ch.com.au/developers — docs at /developers/docs, CLI at /cli/mt.js, quotes at GET /api/v1/cryptocurrency/quotes/latest?symbol=MT, Play SDK at /sdk/mt-play.js. Support: support@futuret3ch.com.au";
      ...
      reply = "TAP is trips, packages, and food deliveries — like Uber, Dasher, and Panda. Not games. TAPSHOP is trade. TAPMATCH is work (employees and employers). Sign in to the portal once; those desks are inside, separate from profile and chat. Games live in the catalog.";
