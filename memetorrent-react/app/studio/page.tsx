  ...
  return (
    <div className="max-w-6xl mx-auto px-4 sm:px-6 py-8">
      ...
      <div className="flex flex-wrap items-end justify-between gap-4 mb-4">
        <div>
          <div className="uppercase text-xs tracking-[3px] text-emerald-400 mb-1">MT Game Studio</div>
          <h1 className="text-3xl font-semibold tracking-tight">Level editor</h1>
