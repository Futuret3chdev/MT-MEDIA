      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        <div className="grid md:grid-cols-2 gap-x-8 md:gap-x-16 gap-y-8 sm:gap-y-10 items-center">
          <div>
            ...
            <div className="text-xs mt-3 opacity-50">Opens the production INFINITE WALLET at https://mt.futuret3ch.com.au/</div> {/* all memetorrent-react wallet launch links point to the wallet version */}
          </div>
